...
{
	/// <summary>
	/// Description of GVCDSTATI_ISCRIZIONE
	/// </summary>
	public partial class GVCDSTATI_ISCRIZIONE
	{
		...
		private System.Int32 _fLAG_REVISIONE;
		private System.Boolean _fLAG_REVISIONENull = true;

		/// <summary>
		/// Default constructor
		/// </summary>
		public GVCDSTATI_ISCRIZIONE(){}
		...
		/// Flag attivo 0=attivo 1=non attivo
		/// </summary>
		public System.Int32 FLAG_REVISIONE
		{
			get
			{
				if(IsFLAG_REVISIONENull)
					throw new InvalidOperationException("Impossibile leggere il dato in quanto vale DBNull.");
				return _fLAG_REVISIONE;
			}
			set
			{
				_fLAG_REVISIONENull = false;
				_fLAG_REVISIONE = value;
			}
		}
		...
		/// Return true if field is null, otherwise false.
		/// </summary>
		public bool IsFLAG_REVISIONENull
		{
			get
			{
				return _fLAG_REVISIONENull;
			}
			set
			{
				_fLAG_REVISIONENull = value;
			}
		}
		...
		/// </summary>
		/// <returns>The value of the field or String.Empty/-1</returns>
		public System.Int32 FLAG_REVISIONESafe
		{
			get
			{
				if (IsFLAG_REVISIONENull)
					return -1;
				return FLAG_REVISIONE;
			}
		}
