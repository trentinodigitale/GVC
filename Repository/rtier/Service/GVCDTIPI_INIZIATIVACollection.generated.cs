...
{
	/// <summary>
	/// Data Access Layer for the object GVCDTIPI_INIZIATIVA
	/// </summary>
	public partial class GVCDTIPI_INIZIATIVACollection
	{
		/// <summary>
		...
		public GVCDTIPI_INIZIATIVACollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <returns>Array of objects GVCDTIPI_INIZIATIVA</returns>
		public virtual GVCDTIPI_INIZIATIVA[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <returns>DataTable of objects GVCDTIPI_INIZIATIVA</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDTIPI_INIZIATIVA
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDTIPI_INIZIATIVA selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDTIPI_INIZIATIVA</returns>
		public GVCDTIPI_INIZIATIVA GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDTIPI_INIZIATIVA[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDTIPI_INIZIATIVA selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDTIPI_INIZIATIVA</returns>
		public GVCDTIPI_INIZIATIVA[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDTIPI_INIZIATIVA selected by 
		...
		/// <returns>Array of objects GVCDTIPI_INIZIATIVA</returns>
		public virtual GVCDTIPI_INIZIATIVA[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDTIPI_INIZIATIVA selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDTIPI_INIZIATIVA selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCDTIPI_INIZIATIVA ");
		...
		/// <summary>
		/// Returns an object GVCDTIPI_INIZIATIVA selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDTIPI_INIZIATIVA</returns>
		public virtual GVCDTIPI_INIZIATIVA GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDTIPI_INIZIATIVA[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDTIPI_INIZIATIVA valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDTIPI_INIZIATIVA_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDTIPI_INIZIATIVA (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO) " +
			"VALUES (" + id.ToString() + ", " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDTIPI_INIZIATIVA valore)
		{
			System.String sqlStr = "UPDATE GVCDTIPI_INIZIATIVA SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDTIPI_INIZIATIVA</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDTIPI_INIZIATIVA valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDTIPI_INIZIATIVA selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDTIPI_INIZIATIVA selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDTIPI_INIZIATIVA");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDTIPI_INIZIATIVA</returns>
		protected GVCDTIPI_INIZIATIVA[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDTIPI_INIZIATIVA</returns>
		protected GVCDTIPI_INIZIATIVA[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDTIPI_INIZIATIVA</returns>
		protected virtual GVCDTIPI_INIZIATIVA[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDTIPI_INIZIATIVA record = new GVCDTIPI_INIZIATIVA();
			...
			return (GVCDTIPI_INIZIATIVA[])(recordList.ToArray(typeof(GVCDTIPI_INIZIATIVA)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDTIPI_INIZIATIVA</returns>
		protected virtual GVCDTIPI_INIZIATIVA MapRow(DataRow row)
		{
			GVCDTIPI_INIZIATIVA mappedObject = new GVCDTIPI_INIZIATIVA();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDTIPI_INIZIATIVA
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDTIPI_INIZIATIVA";
			DataColumn dataColumn;
