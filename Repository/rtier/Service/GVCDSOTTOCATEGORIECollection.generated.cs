...
{
	/// <summary>
	/// Data Access Layer for the object GVCDSOTTOCATEGORIE
	/// </summary>
	public partial class GVCDSOTTOCATEGORIECollection
	{
		/// <summary>
		...
		public GVCDSOTTOCATEGORIECollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDSOTTOCATEGORIE
		/// </summary>
		/// <returns>Array of objects GVCDSOTTOCATEGORIE</returns>
		public virtual GVCDSOTTOCATEGORIE[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDSOTTOCATEGORIE
		/// </summary>
		/// <returns>DataTable of objects GVCDSOTTOCATEGORIE</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDSOTTOCATEGORIE
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDSOTTOCATEGORIE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDSOTTOCATEGORIE</returns>
		public GVCDSOTTOCATEGORIE GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDSOTTOCATEGORIE[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDSOTTOCATEGORIE selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDSOTTOCATEGORIE</returns>
		public GVCDSOTTOCATEGORIE[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDSOTTOCATEGORIE selected by 
		...
		/// <returns>Array of objects GVCDSOTTOCATEGORIE</returns>
		public virtual GVCDSOTTOCATEGORIE[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDSOTTOCATEGORIE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDSOTTOCATEGORIE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCDSOTTOCATEGORIE ");
		...
		/// <summary>
		/// Returns an object GVCDSOTTOCATEGORIE selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDSOTTOCATEGORIE</returns>
		public virtual GVCDSOTTOCATEGORIE GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDSOTTOCATEGORIE[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDSOTTOCATEGORIE valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDSOTTOCATEGORIE_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDSOTTOCATEGORIE (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO) " +
			"VALUES (" + id.ToString() + ", " +
			...
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				...
				AddParameter(cmd, "FLAG_ATTIVO", valore.FLAG_ATTIVO);
				cmd.ExecuteScalar();
				valore.IDOBJ = id;
			}
		}
		...
		/// <summary>
		/// Updates in the Database an object GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDSOTTOCATEGORIE valore)
		{
			System.String sqlStr = "UPDATE GVCDSOTTOCATEGORIE SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDSOTTOCATEGORIE</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDSOTTOCATEGORIE valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDSOTTOCATEGORIE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDSOTTOCATEGORIE selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDSOTTOCATEGORIE");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDSOTTOCATEGORIE
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDSOTTOCATEGORIE</returns>
		protected GVCDSOTTOCATEGORIE[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDSOTTOCATEGORIE</returns>
		protected GVCDSOTTOCATEGORIE[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDSOTTOCATEGORIE</returns>
		protected virtual GVCDSOTTOCATEGORIE[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDSOTTOCATEGORIE record = new GVCDSOTTOCATEGORIE();
			...
			return (GVCDSOTTOCATEGORIE[])(recordList.ToArray(typeof(GVCDSOTTOCATEGORIE)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDSOTTOCATEGORIE
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDSOTTOCATEGORIE</returns>
		protected virtual GVCDSOTTOCATEGORIE MapRow(DataRow row)
		{
			GVCDSOTTOCATEGORIE mappedObject = new GVCDSOTTOCATEGORIE();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDSOTTOCATEGORIE
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDSOTTOCATEGORIE";
			DataColumn dataColumn;
