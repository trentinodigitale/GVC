...
{
	/// <summary>
	/// Description of GVCDTIPI_CARICA
	/// </summary>
	public partial class GVCDTIPI_CARICA
	{
		private System.Int32 _iDOBJ;
		private System.String _dESCRIZIONE;
		private System.Int32 _fLAG_ANTIMAFIA;
		private System.Boolean _fLAG_ANTIMAFIANull = true;
		...
		/// <summary>
		/// 1= richiesta antimafia
		/// </summary>
		public System.Int32 FLAG_ANTIMAFIA
		{
			get
			{
				if(IsFLAG_ANTIMAFIANull)
					throw new InvalidOperationException("Impossibile leggere il dato in quanto vale DBNull.");
				return _fLAG_ANTIMAFIA;
			}
			set
			{
				_fLAG_ANTIMAFIANull = false;
				_fLAG_ANTIMAFIA = value;
			}
		}
		...
		/// </summary>
		public bool IsFLAG_ANTIMAFIANull
		{
			get
			{
				return _fLAG_ANTIMAFIANull;
			}
			set
			{
				_fLAG_ANTIMAFIANull = value;
			}
		}
		...
		public System.Int32 FLAG_ANTIMAFIASafe
		{
			get
			{
				if (IsFLAG_ANTIMAFIANull)
					return -1;
				return FLAG_ANTIMAFIA;
			}
		}
