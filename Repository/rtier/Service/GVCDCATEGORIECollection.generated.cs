...
{
	/// <summary>
	/// Data Access Layer for the object GVCDCATEGORIE
	/// </summary>
	public partial class GVCDCATEGORIECollection
	{
		/// <summary>
		...
		public GVCDCATEGORIECollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDCATEGORIE
		/// </summary>
		/// <returns>Array of objects GVCDCATEGORIE</returns>
		public virtual GVCDCATEGORIE[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDCATEGORIE
		/// </summary>
		/// <returns>DataTable of objects GVCDCATEGORIE</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDCATEGORIE
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDCATEGORIE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDCATEGORIE</returns>
		public GVCDCATEGORIE GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDCATEGORIE[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDCATEGORIE selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDCATEGORIE</returns>
		public GVCDCATEGORIE[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDCATEGORIE selected by 
		...
		/// <returns>Array of objects GVCDCATEGORIE</returns>
		public virtual GVCDCATEGORIE[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDCATEGORIE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDCATEGORIE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an object GVCDCATEGORIE selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDCATEGORIE</returns>
		public virtual GVCDCATEGORIE GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDCATEGORIE[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDCATEGORIE
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDCATEGORIE valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDCATEGORIE_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDCATEGORIE (" +
			"IDOBJ, " +
			"CODICE, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO) " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDCATEGORIE
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDCATEGORIE valore)
		{
			System.String sqlStr = "UPDATE GVCDCATEGORIE SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDCATEGORIE
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDCATEGORIE</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDCATEGORIE
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDCATEGORIE valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDCATEGORIE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDCATEGORIE selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDCATEGORIE");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDCATEGORIE
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDCATEGORIE
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDCATEGORIE</returns>
		protected GVCDCATEGORIE[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDCATEGORIE</returns>
		protected GVCDCATEGORIE[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDCATEGORIE
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDCATEGORIE</returns>
		protected virtual GVCDCATEGORIE[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDCATEGORIE record = new GVCDCATEGORIE();
			...
			return (GVCDCATEGORIE[])(recordList.ToArray(typeof(GVCDCATEGORIE)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDCATEGORIE
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDCATEGORIE</returns>
		protected virtual GVCDCATEGORIE MapRow(DataRow row)
		{
			GVCDCATEGORIE mappedObject = new GVCDCATEGORIE();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDCATEGORIE
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDCATEGORIE";
			DataColumn dataColumn;
