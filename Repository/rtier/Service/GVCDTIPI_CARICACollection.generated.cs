...
{
	/// <summary>
	/// Data Access Layer for the object GVCDTIPI_CARICA
	/// </summary>
	public partial class GVCDTIPI_CARICACollection
	{
		/// <summary>
		...
		/// <summary>
		/// Returns the Database Name of the field FLAG_ANTIMAFIA.
		/// </summary>
		public const string FLAG_ANTIMAFIAColumnName = "FLAG_ANTIMAFIA";
		/// <summary>
		...
		public GVCDTIPI_CARICACollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDTIPI_CARICA
		/// </summary>
		/// <returns>Array of objects GVCDTIPI_CARICA</returns>
		public virtual GVCDTIPI_CARICA[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDTIPI_CARICA
		/// </summary>
		/// <returns>DataTable of objects GVCDTIPI_CARICA</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDTIPI_CARICA
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDTIPI_CARICA selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDTIPI_CARICA</returns>
		public GVCDTIPI_CARICA GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDTIPI_CARICA[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDTIPI_CARICA selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDTIPI_CARICA</returns>
		public GVCDTIPI_CARICA[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDTIPI_CARICA selected by 
		...
		/// <returns>Array of objects GVCDTIPI_CARICA</returns>
		public virtual GVCDTIPI_CARICA[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDTIPI_CARICA selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDTIPI_CARICA selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FLAG_ANTIMAFIA, ");
			sql.Append("FLAG_ATTIVO ");
			sql.Append("FROM GVCDTIPI_CARICA ");
		...
		/// <summary>
		/// Returns an object GVCDTIPI_CARICA selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDTIPI_CARICA</returns>
		public virtual GVCDTIPI_CARICA GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDTIPI_CARICA[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDTIPI_CARICA
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDTIPI_CARICA valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDTIPI_CARICA_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDTIPI_CARICA (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ANTIMAFIA, " +
			"FLAG_ATTIVO) " +
			...
			_db.CreateSqlParameterName("FLAG_ANTIMAFIA") + ", " +
			_db.CreateSqlParameterName("FLAG_ATTIVO") + ")";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				AddParameter(cmd, "DESCRIZIONE", valore.DESCRIZIONE);
				AddParameter(cmd, "FLAG_ANTIMAFIA", valore.IsFLAG_ANTIMAFIANull ? DBNull.Value : (object)valore.FLAG_ANTIMAFIA);
		...
		/// <summary>
		/// Updates in the Database an object GVCDTIPI_CARICA
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDTIPI_CARICA valore)
		{
			System.String sqlStr = "UPDATE GVCDTIPI_CARICA SET " +
				"DESCRIZIONE = " + _db.CreateSqlParameterName("DESCRIZIONE") + ", " +
				"FLAG_ANTIMAFIA = " + _db.CreateSqlParameterName("FLAG_ANTIMAFIA") + ", " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDTIPI_CARICA
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDTIPI_CARICA</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDTIPI_CARICA
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDTIPI_CARICA valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDTIPI_CARICA selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDTIPI_CARICA selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDTIPI_CARICA");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDTIPI_CARICA
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDTIPI_CARICA
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDTIPI_CARICA</returns>
		protected GVCDTIPI_CARICA[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDTIPI_CARICA</returns>
		protected GVCDTIPI_CARICA[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDTIPI_CARICA
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDTIPI_CARICA</returns>
		protected virtual GVCDTIPI_CARICA[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			int fLAG_ANTIMAFIAColumnIndex = reader.GetOrdinal("FLAG_ANTIMAFIA");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDTIPI_CARICA record = new GVCDTIPI_CARICA();
					...
					if(!reader.IsDBNull(fLAG_ANTIMAFIAColumnIndex))
						record.FLAG_ANTIMAFIA = Convert.ToInt32(reader.GetValue(fLAG_ANTIMAFIAColumnIndex));
			...
			return (GVCDTIPI_CARICA[])(recordList.ToArray(typeof(GVCDTIPI_CARICA)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDTIPI_CARICA
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDTIPI_CARICA</returns>
		protected virtual GVCDTIPI_CARICA MapRow(DataRow row)
		{
			GVCDTIPI_CARICA mappedObject = new GVCDTIPI_CARICA();
			...
			//Campo "FLAG_ANTIMAFIA"
			dataColumn = dataTable.Columns["FLAG_ANTIMAFIA"];
			if(!row.IsNull(dataColumn))
				mappedObject.FLAG_ANTIMAFIA = (System.Int32)row[dataColumn];
			//Campo "FLAG_ATTIVO"
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDTIPI_CARICA
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDTIPI_CARICA";
			DataColumn dataColumn;
			...
			dataColumn = dataTable.Columns.Add("FLAG_ANTIMAFIA", typeof(System.Int32));
