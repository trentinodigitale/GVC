...
{
	/// <summary>
	/// Data Access Layer for the object GVCTSTORICO_REGISTRO
	/// </summary>
	public partial class GVCTSTORICO_REGISTROCollection
	{
		/// <summary>
		...
		public GVCTSTORICO_REGISTROCollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <returns>Array of objects GVCTSTORICO_REGISTRO</returns>
		public virtual GVCTSTORICO_REGISTRO[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <returns>DataTable of objects GVCTSTORICO_REGISTRO</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCTSTORICO_REGISTRO
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCTSTORICO_REGISTRO selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCTSTORICO_REGISTRO</returns>
		public GVCTSTORICO_REGISTRO GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCTSTORICO_REGISTRO[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCTSTORICO_REGISTRO selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCTSTORICO_REGISTRO</returns>
		public GVCTSTORICO_REGISTRO[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCTSTORICO_REGISTRO selected by 
		...
		/// <returns>Array of objects GVCTSTORICO_REGISTRO</returns>
		public virtual GVCTSTORICO_REGISTRO[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCTSTORICO_REGISTRO selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCTSTORICO_REGISTRO selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCTSTORICO_REGISTRO ");
		...
		/// <summary>
		/// Returns an object GVCTSTORICO_REGISTRO selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCTSTORICO_REGISTRO</returns>
		public virtual GVCTSTORICO_REGISTRO GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCTSTORICO_REGISTRO[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Returns an object GVCTSTORICO_REGISTRO selected by a foreign key
		/// </summary>
		/// <param name="iDOBJ_REGISTRO">The foreign key of the object</param>
		/// <returns>Object of type GVCTSTORICO_REGISTRO</returns>
		public virtual GVCTSTORICO_REGISTRO[] GetByIDOBJ_REGISTRO(System.Int32 iDOBJ_REGISTRO)
		{
			return MapRecords(CreateGetByIDOBJ_REGISTROCommand(iDOBJ_REGISTRO));
		}

		/// <summary>
		/// Returns a DataTable of objects GVCTSTORICO_REGISTRO selected by a foreign key
		/// </summary>
		/// <param name="iDOBJ_REGISTRO">The foreign key of the object</param>
		...
		/// <summary>
		/// Deletes from the Database the objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="iDOBJ_REGISTRO">The foreign key</param>
		...
		/// <summary>
		/// Creates the IDbCommand for the deletion from the Database of the objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="iDOBJ_REGISTRO">The foreign key</param>
		...
		/// <summary>
		/// Inserts in the Database an object GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCTSTORICO_REGISTRO valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCTSTORICO_REGISTRO_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCTSTORICO_REGISTRO (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"IDOBJ_REGISTRO, " +
			"DATA_FINE, " +
		...
		/// <summary>
		/// Updates in the Database an object GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCTSTORICO_REGISTRO valore)
		{
			System.String sqlStr = "UPDATE GVCTSTORICO_REGISTRO SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="table">The DataTable of objects GVCTSTORICO_REGISTRO</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCTSTORICO_REGISTRO valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCTSTORICO_REGISTRO selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCTSTORICO_REGISTRO selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCTSTORICO_REGISTRO");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCTSTORICO_REGISTRO</returns>
		protected GVCTSTORICO_REGISTRO[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCTSTORICO_REGISTRO</returns>
		protected GVCTSTORICO_REGISTRO[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCTSTORICO_REGISTRO</returns>
		protected virtual GVCTSTORICO_REGISTRO[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCTSTORICO_REGISTRO record = new GVCTSTORICO_REGISTRO();
			...
			return (GVCTSTORICO_REGISTRO[])(recordList.ToArray(typeof(GVCTSTORICO_REGISTRO)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCTSTORICO_REGISTRO
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCTSTORICO_REGISTRO</returns>
		protected virtual GVCTSTORICO_REGISTRO MapRow(DataRow row)
		{
			GVCTSTORICO_REGISTRO mappedObject = new GVCTSTORICO_REGISTRO();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCTSTORICO_REGISTRO
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCTSTORICO_REGISTRO";
			DataColumn dataColumn;
