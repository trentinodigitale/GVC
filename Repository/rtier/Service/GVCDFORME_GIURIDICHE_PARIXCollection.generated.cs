...
{
	/// <summary>
	/// Data Access Layer for the object GVCDFORME_GIURIDICHE_PARIX
	/// </summary>
	public partial class GVCDFORME_GIURIDICHE_PARIXCollection
	{
		/// <summary>
		...
		public GVCDFORME_GIURIDICHE_PARIXCollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <returns>Array of objects GVCDFORME_GIURIDICHE_PARIX</returns>
		public virtual GVCDFORME_GIURIDICHE_PARIX[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <returns>DataTable of objects GVCDFORME_GIURIDICHE_PARIX</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDFORME_GIURIDICHE_PARIX selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDFORME_GIURIDICHE_PARIX</returns>
		public GVCDFORME_GIURIDICHE_PARIX GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDFORME_GIURIDICHE_PARIX[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDFORME_GIURIDICHE_PARIX selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDFORME_GIURIDICHE_PARIX</returns>
		public GVCDFORME_GIURIDICHE_PARIX[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDFORME_GIURIDICHE_PARIX selected by 
		...
		/// <returns>Array of objects GVCDFORME_GIURIDICHE_PARIX</returns>
		public virtual GVCDFORME_GIURIDICHE_PARIX[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDFORME_GIURIDICHE_PARIX selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDFORME_GIURIDICHE_PARIX selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCDFORME_GIURIDICHE_PARIX ");
		...
		/// <summary>
		/// Returns an object GVCDFORME_GIURIDICHE_PARIX selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDFORME_GIURIDICHE_PARIX</returns>
		public virtual GVCDFORME_GIURIDICHE_PARIX GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDFORME_GIURIDICHE_PARIX[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDFORME_GIURIDICHE_PARIX valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDFORME_GIURIDICHE_PARIX_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDFORME_GIURIDICHE_PARIX (" +
			"IDOBJ, " +
			"CODICE, " +
			"DESCRIZIONE) " +
			"VALUES (" + id.ToString() + ", " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDFORME_GIURIDICHE_PARIX valore)
		{
			System.String sqlStr = "UPDATE GVCDFORME_GIURIDICHE_PARIX SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDFORME_GIURIDICHE_PARIX</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDFORME_GIURIDICHE_PARIX valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDFORME_GIURIDICHE_PARIX selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDFORME_GIURIDICHE_PARIX selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDFORME_GIURIDICHE_PARIX");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDFORME_GIURIDICHE_PARIX</returns>
		protected GVCDFORME_GIURIDICHE_PARIX[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDFORME_GIURIDICHE_PARIX</returns>
		protected GVCDFORME_GIURIDICHE_PARIX[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDFORME_GIURIDICHE_PARIX</returns>
		protected virtual GVCDFORME_GIURIDICHE_PARIX[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDFORME_GIURIDICHE_PARIX record = new GVCDFORME_GIURIDICHE_PARIX();
			...
			return (GVCDFORME_GIURIDICHE_PARIX[])(recordList.ToArray(typeof(GVCDFORME_GIURIDICHE_PARIX)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDFORME_GIURIDICHE_PARIX</returns>
		protected virtual GVCDFORME_GIURIDICHE_PARIX MapRow(DataRow row)
		{
			GVCDFORME_GIURIDICHE_PARIX mappedObject = new GVCDFORME_GIURIDICHE_PARIX();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDFORME_GIURIDICHE_PARIX
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDFORME_GIURIDICHE_PARIX";
			DataColumn dataColumn;
