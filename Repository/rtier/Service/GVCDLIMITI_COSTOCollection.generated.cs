//
//Generated by gvc at 08/04/2010 14.47.35
//
...
{
	/// <summary>
	/// Data Access Layer for the object GVCDLIMITI_COSTO
	/// </summary>
	public partial class GVCDLIMITI_COSTOCollection
	{
		/// <summary>
		...
		public GVCDLIMITI_COSTOCollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDLIMITI_COSTO
		/// </summary>
		/// <returns>Array of objects GVCDLIMITI_COSTO</returns>
		public virtual GVCDLIMITI_COSTO[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDLIMITI_COSTO
		/// </summary>
		/// <returns>DataTable of objects GVCDLIMITI_COSTO</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDLIMITI_COSTO
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDLIMITI_COSTO selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDLIMITI_COSTO</returns>
		public GVCDLIMITI_COSTO GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDLIMITI_COSTO[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDLIMITI_COSTO selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDLIMITI_COSTO</returns>
		public GVCDLIMITI_COSTO[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDLIMITI_COSTO selected by 
		...
		/// <returns>Array of objects GVCDLIMITI_COSTO</returns>
		public virtual GVCDLIMITI_COSTO[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDLIMITI_COSTO selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDLIMITI_COSTO selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("CODICE ");
			sql.Append("FROM GVCDLIMITI_COSTO ");
		...
		/// <summary>
		/// Returns an object GVCDLIMITI_COSTO selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDLIMITI_COSTO</returns>
		public virtual GVCDLIMITI_COSTO GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDLIMITI_COSTO[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDLIMITI_COSTO valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDLIMITI_COSTO_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDLIMITI_COSTO (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO, " +
			"CODICE) " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDLIMITI_COSTO valore)
		{
			System.String sqlStr = "UPDATE GVCDLIMITI_COSTO SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDLIMITI_COSTO</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDLIMITI_COSTO valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDLIMITI_COSTO selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDLIMITI_COSTO selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDLIMITI_COSTO");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDLIMITI_COSTO
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDLIMITI_COSTO</returns>
		protected GVCDLIMITI_COSTO[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDLIMITI_COSTO</returns>
		protected GVCDLIMITI_COSTO[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDLIMITI_COSTO</returns>
		protected virtual GVCDLIMITI_COSTO[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDLIMITI_COSTO record = new GVCDLIMITI_COSTO();
			...
			return (GVCDLIMITI_COSTO[])(recordList.ToArray(typeof(GVCDLIMITI_COSTO)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDLIMITI_COSTO
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDLIMITI_COSTO</returns>
		protected virtual GVCDLIMITI_COSTO MapRow(DataRow row)
		{
			GVCDLIMITI_COSTO mappedObject = new GVCDLIMITI_COSTO();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDLIMITI_COSTO
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDLIMITI_COSTO";
			DataColumn dataColumn;
