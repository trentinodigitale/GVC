...
{
	/// <summary>
	/// Data Access Layer for the object GVCDTIPI_LIQ_COATTE
	/// </summary>
	public partial class GVCDTIPI_LIQ_COATTECollection
	{
		/// <summary>
		...
		public GVCDTIPI_LIQ_COATTECollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <returns>Array of objects GVCDTIPI_LIQ_COATTE</returns>
		public virtual GVCDTIPI_LIQ_COATTE[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <returns>DataTable of objects GVCDTIPI_LIQ_COATTE</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDTIPI_LIQ_COATTE
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDTIPI_LIQ_COATTE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDTIPI_LIQ_COATTE</returns>
		public GVCDTIPI_LIQ_COATTE GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDTIPI_LIQ_COATTE[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDTIPI_LIQ_COATTE selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDTIPI_LIQ_COATTE</returns>
		public GVCDTIPI_LIQ_COATTE[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDTIPI_LIQ_COATTE selected by 
		...
		/// <returns>Array of objects GVCDTIPI_LIQ_COATTE</returns>
		public virtual GVCDTIPI_LIQ_COATTE[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDTIPI_LIQ_COATTE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDTIPI_LIQ_COATTE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCDTIPI_LIQ_COATTE ");
		...
		/// <summary>
		/// Returns an object GVCDTIPI_LIQ_COATTE selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDTIPI_LIQ_COATTE</returns>
		public virtual GVCDTIPI_LIQ_COATTE GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDTIPI_LIQ_COATTE[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDTIPI_LIQ_COATTE valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDTIPI_LIQ_COATTE_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDTIPI_LIQ_COATTE (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO) " +
			"VALUES (" + id.ToString() + ", " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDTIPI_LIQ_COATTE valore)
		{
			System.String sqlStr = "UPDATE GVCDTIPI_LIQ_COATTE SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDTIPI_LIQ_COATTE</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDTIPI_LIQ_COATTE valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDTIPI_LIQ_COATTE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDTIPI_LIQ_COATTE selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDTIPI_LIQ_COATTE");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDTIPI_LIQ_COATTE</returns>
		protected GVCDTIPI_LIQ_COATTE[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDTIPI_LIQ_COATTE</returns>
		protected GVCDTIPI_LIQ_COATTE[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDTIPI_LIQ_COATTE</returns>
		protected virtual GVCDTIPI_LIQ_COATTE[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDTIPI_LIQ_COATTE record = new GVCDTIPI_LIQ_COATTE();
			...
			return (GVCDTIPI_LIQ_COATTE[])(recordList.ToArray(typeof(GVCDTIPI_LIQ_COATTE)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDTIPI_LIQ_COATTE</returns>
		protected virtual GVCDTIPI_LIQ_COATTE MapRow(DataRow row)
		{
			GVCDTIPI_LIQ_COATTE mappedObject = new GVCDTIPI_LIQ_COATTE();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDTIPI_LIQ_COATTE
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDTIPI_LIQ_COATTE";
			DataColumn dataColumn;
