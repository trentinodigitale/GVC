...
{
	/// <summary>
	/// Data Access Layer for the object GVCDFORME_GIURIDICHE
	/// </summary>
	public partial class GVCDFORME_GIURIDICHECollection
	{
		/// <summary>
		...
		public GVCDFORME_GIURIDICHECollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDFORME_GIURIDICHE
		/// </summary>
		/// <returns>Array of objects GVCDFORME_GIURIDICHE</returns>
		public virtual GVCDFORME_GIURIDICHE[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDFORME_GIURIDICHE
		/// </summary>
		/// <returns>DataTable of objects GVCDFORME_GIURIDICHE</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDFORME_GIURIDICHE
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDFORME_GIURIDICHE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDFORME_GIURIDICHE</returns>
		public GVCDFORME_GIURIDICHE GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDFORME_GIURIDICHE[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDFORME_GIURIDICHE selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDFORME_GIURIDICHE</returns>
		public GVCDFORME_GIURIDICHE[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDFORME_GIURIDICHE selected by 
		...
		/// <returns>Array of objects GVCDFORME_GIURIDICHE</returns>
		public virtual GVCDFORME_GIURIDICHE[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDFORME_GIURIDICHE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDFORME_GIURIDICHE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCDFORME_GIURIDICHE ");
		...
		/// <summary>
		/// Returns an object GVCDFORME_GIURIDICHE selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDFORME_GIURIDICHE</returns>
		public virtual GVCDFORME_GIURIDICHE GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDFORME_GIURIDICHE[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDFORME_GIURIDICHE valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDFORME_GIURIDICHE_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDFORME_GIURIDICHE (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO) " +
			"VALUES (" + id.ToString() + ", " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDFORME_GIURIDICHE valore)
		{
			System.String sqlStr = "UPDATE GVCDFORME_GIURIDICHE SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDFORME_GIURIDICHE</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDFORME_GIURIDICHE valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDFORME_GIURIDICHE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDFORME_GIURIDICHE selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDFORME_GIURIDICHE");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDFORME_GIURIDICHE
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDFORME_GIURIDICHE</returns>
		protected GVCDFORME_GIURIDICHE[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDFORME_GIURIDICHE</returns>
		protected GVCDFORME_GIURIDICHE[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDFORME_GIURIDICHE</returns>
		protected virtual GVCDFORME_GIURIDICHE[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDFORME_GIURIDICHE record = new GVCDFORME_GIURIDICHE();
			...
			return (GVCDFORME_GIURIDICHE[])(recordList.ToArray(typeof(GVCDFORME_GIURIDICHE)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDFORME_GIURIDICHE
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDFORME_GIURIDICHE</returns>
		protected virtual GVCDFORME_GIURIDICHE MapRow(DataRow row)
		{
			GVCDFORME_GIURIDICHE mappedObject = new GVCDFORME_GIURIDICHE();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDFORME_GIURIDICHE
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDFORME_GIURIDICHE";
			DataColumn dataColumn;
