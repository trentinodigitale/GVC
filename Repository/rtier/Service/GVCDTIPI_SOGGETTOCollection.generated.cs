...
{
	/// <summary>
	/// Data Access Layer for the object GVCDTIPI_SOGGETTO
	/// </summary>
	public partial class GVCDTIPI_SOGGETTOCollection
	{
		/// <summary>
		...
		/// <summary>
		/// Returns the Database Name of the field FLAG_APERTO.
		/// </summary>
		public const string FLAG_APERTOColumnName = "FLAG_APERTO";
		...
		public GVCDTIPI_SOGGETTOCollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDTIPI_SOGGETTO
		/// </summary>
		/// <returns>Array of objects GVCDTIPI_SOGGETTO</returns>
		public virtual GVCDTIPI_SOGGETTO[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDTIPI_SOGGETTO
		/// </summary>
		/// <returns>DataTable of objects GVCDTIPI_SOGGETTO</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDTIPI_SOGGETTO
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDTIPI_SOGGETTO selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDTIPI_SOGGETTO</returns>
		public GVCDTIPI_SOGGETTO GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDTIPI_SOGGETTO[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDTIPI_SOGGETTO selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDTIPI_SOGGETTO</returns>
		public GVCDTIPI_SOGGETTO[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDTIPI_SOGGETTO selected by 
		...
		/// <returns>Array of objects GVCDTIPI_SOGGETTO</returns>
		public virtual GVCDTIPI_SOGGETTO[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDTIPI_SOGGETTO selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDTIPI_SOGGETTO selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FLAG_APERTO ");
			sql.Append("FROM GVCDTIPI_SOGGETTO ");
		...
		/// <summary>
		/// Returns an object GVCDTIPI_SOGGETTO selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDTIPI_SOGGETTO</returns>
		public virtual GVCDTIPI_SOGGETTO GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDTIPI_SOGGETTO[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDTIPI_SOGGETTO valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDTIPI_SOGGETTO_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDTIPI_SOGGETTO (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO, " +
			"FLAG_APERTO) " +
			...
			_db.CreateSqlParameterName("FLAG_APERTO") + ")";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				...
				AddParameter(cmd, "FLAG_APERTO", valore.IsFLAG_APERTONull ? DBNull.Value : (object)valore.FLAG_APERTO);
				cmd.ExecuteScalar();
				valore.IDOBJ = id;
			}
		}
		...
		/// <summary>
		/// Updates in the Database an object GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDTIPI_SOGGETTO valore)
		{
			System.String sqlStr = "UPDATE GVCDTIPI_SOGGETTO SET " +
				"DESCRIZIONE = " + _db.CreateSqlParameterName("DESCRIZIONE") + ", " +
				"FLAG_ATTIVO = " + _db.CreateSqlParameterName("FLAG_ATTIVO") + ", " +
				"FLAG_APERTO = " + _db.CreateSqlParameterName("FLAG_APERTO") +
				" WHERE " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDTIPI_SOGGETTO</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDTIPI_SOGGETTO valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDTIPI_SOGGETTO selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDTIPI_SOGGETTO selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDTIPI_SOGGETTO");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDTIPI_SOGGETTO
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDTIPI_SOGGETTO</returns>
		protected GVCDTIPI_SOGGETTO[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDTIPI_SOGGETTO</returns>
		protected GVCDTIPI_SOGGETTO[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDTIPI_SOGGETTO</returns>
		protected virtual GVCDTIPI_SOGGETTO[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			int fLAG_APERTOColumnIndex = reader.GetOrdinal("FLAG_APERTO");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDTIPI_SOGGETTO record = new GVCDTIPI_SOGGETTO();
					...
					if(!reader.IsDBNull(fLAG_APERTOColumnIndex))
						record.FLAG_APERTO = Convert.ToInt32(reader.GetValue(fLAG_APERTOColumnIndex));
					if(ri == length && totalRecordCount != 0)
						break;
				}
			}
			totalRecordCount = 0 == totalRecordCount ? ri + startIndex : -1;
			return (GVCDTIPI_SOGGETTO[])(recordList.ToArray(typeof(GVCDTIPI_SOGGETTO)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDTIPI_SOGGETTO
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDTIPI_SOGGETTO</returns>
		protected virtual GVCDTIPI_SOGGETTO MapRow(DataRow row)
		{
			GVCDTIPI_SOGGETTO mappedObject = new GVCDTIPI_SOGGETTO();
			...
			//Campo "FLAG_APERTO"
			dataColumn = dataTable.Columns["FLAG_APERTO"];
			if(!row.IsNull(dataColumn))
				mappedObject.FLAG_APERTO = (System.Int32)row[dataColumn];
			return mappedObject;
		}

		/// <summary>
		/// Creates a DataTable to store the objects GVCDTIPI_SOGGETTO
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDTIPI_SOGGETTO";
			DataColumn dataColumn;
			...
			dataColumn.Unique = false;
			dataColumn.AutoIncrement = false;
			dataColumn = dataTable.Columns.Add("FLAG_APERTO", typeof(System.Int32));
			dataColumn.AllowDBNull = true;
			dataColumn.ReadOnly = false;
			dataColumn.Unique = false;
			dataColumn.AutoIncrement = false;
