...
{
	/// <summary>
	/// Data Access Layer for the object GVCDESITI_REVISIONE
	/// </summary>
	public partial class GVCDESITI_REVISIONECollection
	{
		/// <summary>
		...
		public GVCDESITI_REVISIONECollection(GVC db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Returns an array containing all the objects GVCDESITI_REVISIONE
		/// </summary>
		/// <returns>Array of objects GVCDESITI_REVISIONE</returns>
		public virtual GVCDESITI_REVISIONE[] GetAll()
		{
			return MapRecords(CreateGetAllCommand());
		}

		/// <summary>
		/// Returns a DataTable containing all the objects GVCDESITI_REVISIONE
		/// </summary>
		/// <returns>DataTable of objects GVCDESITI_REVISIONE</returns>
		...
		/// <summary>
		/// Returns an IDbCommand to get all the objects GVCDESITI_REVISIONE
		/// </summary>
		...
		/// <summary>
		/// Returns an object GVCDESITI_REVISIONE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Object of type GVCDESITI_REVISIONE</returns>
		public GVCDESITI_REVISIONE GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			GVCDESITI_REVISIONE[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return rows.Length == 0 ? null : rows[0];
		}

		/// <summary>
		/// Returns an array containing the objects GVCDESITI_REVISIONE selected by a WHERE statement
		/// and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		/// <returns>Array of objects GVCDESITI_REVISIONE</returns>
		public GVCDESITI_REVISIONE[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Returns an array containing a subset of the objects GVCDESITI_REVISIONE selected by 
		...
		/// <returns>Array of objects GVCDESITI_REVISIONE</returns>
		public virtual GVCDESITI_REVISIONE[] GetAsArray(string whereSql, string orderBySql, int startIndex, int Length, ref int totalRecordCount)
		{
		...
		/// <summary>
		/// Returns a DataTable containing a subset of the objects GVCDESITI_REVISIONE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to get the objects GVCDESITI_REVISIONE selected by 
		/// a WHERE statement and ordered by ORDER BY statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <param name="orderBySql">The ORDER BY statement</param>
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			sql.Append("FROM GVCDESITI_REVISIONE ");
		...
		/// <summary>
		/// Returns an object GVCDESITI_REVISIONE selected by a primary key
		/// </summary>
		/// <param name="IDOBJ">The primary key of the object</param>
		/// <returns>Object of type GVCDESITI_REVISIONE</returns>
		public virtual GVCDESITI_REVISIONE GetByPrimaryKey(System.Int32 IDOBJ)
		{
			...
			using(IDbCommand cmd = CreateGetCommand(whereSql, null))
			{
				...
				GVCDESITI_REVISIONE[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Inserts in the Database an object GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="valore">The object to insert</param>
		public virtual void Insert(GVCDESITI_REVISIONE valore)
		{
			System.Int32 id = -1;
			System.String sqlStr;

			sqlStr = "SELECT GVCDESITI_REVISIONE_SEQ.NEXTVAL FROM DUAL";
			using(IDbCommand cmd = _db.CreateCommand(sqlStr))
			{
				id = Convert.ToInt32(cmd.ExecuteScalar());
			}

			sqlStr = "INSERT INTO GVCDESITI_REVISIONE (" +
			"IDOBJ, " +
			"DESCRIZIONE, " +
			"FLAG_ATTIVO) " +
			"VALUES (" + id.ToString() + ", " +
		...
		/// <summary>
		/// Updates in the Database an object GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="valore">The object to update</param>
		/// <returns>true if success, otherwise false</returns>
		public virtual bool Update(GVCDESITI_REVISIONE valore)
		{
			System.String sqlStr = "UPDATE GVCDESITI_REVISIONE SET " +
		...
		/// <summary>
		/// Updates in the Database a DataTable of objects GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="table">The DataTable of objects GVCDESITI_REVISIONE</param>
		...
		/// <summary>
		/// Deletes from the Database an object GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="valore">The object to delete</param>
		/// <returns>true if success, otherwise false</returns>
		public bool Delete(GVCDESITI_REVISIONE valore)
		{
		...
		/// <summary>
		/// Deletes from the Database the objects GVCDESITI_REVISIONE selected by a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		...
		/// <summary>
		/// Returns an IDbCommand to delete the objects GVCDESITI_REVISIONE selected by 
		/// a WHERE statement
		/// </summary>
		/// <param name="whereSql">The WHERE statement</param>
		/// <returns>Istance of IDbCommand</returns>
		...
		{
			StringBuilder sql = new StringBuilder("DELETE FROM GVCDESITI_REVISIONE");
			if(whereSql != null && whereSql.Length > 0)
				sql.Append(String.Format(" WHERE {0}", whereSql));
			return _db.CreateCommand(sql.ToString());
		}
		...
		/// <summary>
		/// Deletes all the objects GVCDESITI_REVISIONE
		/// </summary>
		/// <returns>The number of the deleted objects</returns>
		...
		/// <summary>
		/// Converts the IDataReader object to an array of type GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="command">The IDbCommand to execute</param>
		/// <returns>Array of type GVCDESITI_REVISIONE</returns>
		protected GVCDESITI_REVISIONE[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>Array of type GVCDESITI_REVISIONE</returns>
		protected GVCDESITI_REVISIONE[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// <summary>
		/// Converts a subset of the IDataReader object to an array of type GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="reader">The IDataReader to convert</param>
		/// <param name="startIndex">The index of the subset</param>
		/// <param name="length">length of the subset</param>
		/// <param name="totalRecordCount">Number of records</param>
		/// <returns>Array of type GVCDESITI_REVISIONE</returns>
		protected virtual GVCDESITI_REVISIONE[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
		{
			if(startIndex < 0)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					GVCDESITI_REVISIONE record = new GVCDESITI_REVISIONE();
			...
			return (GVCDESITI_REVISIONE[])(recordList.ToArray(typeof(GVCDESITI_REVISIONE)));
		}
		...
		/// <summary>
		/// Converts a DataRow to an object GVCDESITI_REVISIONE
		/// </summary>
		/// <param name="row">The DataRow to convert</param>
		/// <returns>An object GVCDESITI_REVISIONE</returns>
		protected virtual GVCDESITI_REVISIONE MapRow(DataRow row)
		{
			GVCDESITI_REVISIONE mappedObject = new GVCDESITI_REVISIONE();
		...
		/// <summary>
		/// Creates a DataTable to store the objects GVCDESITI_REVISIONE
		/// </summary>
		/// <returns>A DataTable</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "GVCDESITI_REVISIONE";
			DataColumn dataColumn;
