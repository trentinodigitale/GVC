...
{
    public partial class Scissione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {
        ...
        private CollegamentoSocietaFDT GetCurrentItem()
        {
            ...
            if (this.bindingSourceCollSocieta.Current != null)
                toReturn = this.bindingSourceCollSocieta.Current as CollegamentoSocietaFDT;
            return toReturn;
        }
             ...
             if (page != null)
             {
                 ...
                 if (itemSogg != null)
                 {
                     ...
                     if (itemLocal != null)
                     {
                         ...
                         this.bindingSourceCollSocieta.DataSource = itemLocal.SocietaCollegate;
        ...
        private void DeleteCollegamentoSocieta()
        {
            ...
            if (item != null)
            {
                if (ShowConfirmMessage("Cancellazione", "Confermi la cancellazione dell'elemento selezionato?", string.Empty) == DialogResult.Yes)
                {
                    ...
                    {
                        CollegamentoSocietaFDT[] listActual = this.bindingSourceCollSocieta.DataSource as CollegamentoSocietaFDT[];
        ...
        public void SetBindableData(ModificaStatutariaFDT item)
        {
            if (item != null)
            {
                ...
                if (item.SocietaCollegate != null && item.SocietaCollegate.Length > 0)
                    this.bindingSourceCollSocieta.DataSource = item.SocietaCollegate;
            }
        }
