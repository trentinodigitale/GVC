...
{
    public partial class TipiIndirizzo : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_INDIRIZZO;
        private string formTitle = "Gestione tipi indirizzo";
        private string titoloDettaglio = "Tipo indirizzo";
