...
{
    public partial class TipoRevisione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {
        private string tipoDizionario = DictionaryTypes.TIPI_REVISIONE;
        private string formTitle = "Gestione tipi revisione";
        private string titoloDettaglio = "Tipi revisione";
