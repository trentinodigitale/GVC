...
{
    public partial class TipiModificaStatutaria : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_TIPI_MODIFICA;
        private string formTitle = "Gestione tipi modifica statutaria";
        private string titoloDettaglio = "Tipo modifica";
