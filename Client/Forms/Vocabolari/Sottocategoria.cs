...
{
    public partial class Sottocategoria : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.SOTTO_CATEGORIE;
        private string formTitle = "Gestione sottocategorie";
        private string titoloDettaglio = "Sottocategoria";
