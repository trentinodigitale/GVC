...
{
    public partial class EsitoRevisione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.ESITI_REVISIONE;
        private string formTitle = "Gestione esiti revisione";
