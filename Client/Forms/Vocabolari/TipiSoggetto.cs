...
{
    public partial class TipiSoggetto : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_SOGGETTO;
        private string formTitle = "Gestione tipi soggetto";
        private string titoloDettaglio = "Tipo soggetto";
