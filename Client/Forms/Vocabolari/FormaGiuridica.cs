...
{
    public partial class FormaGiuridica : it.dedagroup.GVC.Client.Forms.Common.UserControlSplitContainer
    {

        private string tipoDizionario = DictionaryTypes.FORME_GIURIDICHE;
        private string formTitle = "Gestione forme giuridiche";
        private string titoloDettaglio = "Forma giuridica";
        ...
        private void HandleCurrentItemChanged()
        {
            ...
            if (current != null)
            {
                numeroSociDetail2.UpdateBinding(current.IdElemento, current.Descrizione);
            }
        }
        ...
        private void FormaGiuridica_Load(object sender, EventArgs e)
        {
            if (numeroSociDetail2 != null)
                numeroSociDetail2.SetBindableData(TipoControlloNumeroSoci.PER_FORMAGIURIDICA);
        }
    }
}
