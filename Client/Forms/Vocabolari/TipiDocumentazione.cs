...
{
    public partial class TipiDocumentazione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_DOCUMENTO;
        private string formTitle = "Gestione tipi documentazione";
        private string titoloDettaglio = "Tipo documentazione";
