...
{
    public partial class TipiIniziativa : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_INIZIATIVA;
        private string formTitle = "Gestione tipi iniziativa";
        private string titoloDettaglio = "Tipo iniziativa";
