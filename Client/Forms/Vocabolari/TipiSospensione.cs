...
{
    public partial class TipiSospensione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_SOSPENSIONE;
        private string formTitle = "Gestione tipi sospensione";
        private string titoloDettaglio = "Tipo sospensione";
