...
{
    public partial class TipiAutorizzazione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_AUTORIZZAZIONE;
        private string formTitle = "Gestione tipi autorizzazione";
        private string titoloDettaglio = "Tipo autorizzazione";
