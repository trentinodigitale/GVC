...
{
    public partial class TipiAnnotazione : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_ANNOTAZIONE;
        private string formTitle = "Gestione tipi annotazione";
        private string titoloDettaglio = "Tipo annotazione";
