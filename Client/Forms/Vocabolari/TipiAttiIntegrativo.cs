...
{
    public partial class TipiAttiIntegrativo : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_ATTI;
        private string formTitle = "Gestione atto integrativo";
        private string titoloDettaglio = "Atto integrativo";
