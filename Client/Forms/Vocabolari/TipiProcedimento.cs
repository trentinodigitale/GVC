...
{
    public partial class TipiProcedimento : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_PROCEDIMENTO;
        private string formTitle = "Gestione tipi procedimento";
        private string titoloDettaglio = "Tipo procedimento";
        ...
        private void Add()
        {
            ...
            VocabolariHelp.ManageItem(item, VocabolariHelp.CurrentIndexUndefined,
                                        ...
                                        bindingSourceBaseDizionario, listDictionaries, CreatePage<DizionarioEditWithDetail>());
        }
