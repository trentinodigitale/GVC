...
{
    public partial class GiudiciRicorsi : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {
        private string tipoDizionario = DictionaryTypes.GIUDICI;
        private string formTitle = "Gestione giudici ricorsi";
        private string titoloDettaglio = "Giudici ricorsi";
