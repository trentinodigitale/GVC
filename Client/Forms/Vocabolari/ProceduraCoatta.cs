...
{
    public partial class ProceduraCoatta : it.dedagroup.GVC.Client.Forms.Common.UserControlBase
    {

        private string tipoDizionario = DictionaryTypes.TIPI_PROCEDURE_COATTE;
        private string formTitle = "Gestione tipi procedure coatte";
        private string titoloDettaglio = "Tipo procedura coatta";
